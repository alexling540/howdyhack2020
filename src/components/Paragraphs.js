        ...
        <div className="par__container">
            <div className='par'>
                ...
                <h5>
                    ...
                    The adding sunglasses functionality on video footage will enable individuals to edit footage such that the individual in the video will be wearing sunglasses.
                    This functionality is useful for detectives in that they can send video messages of precaution to their team, but in the case that their message is intercepted no one’s safety will be compromised because the identities will be hidden by the sunglasses.
                <br />
                    <br />
